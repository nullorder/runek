...
This very documentation is a Runek world: a walkable library built from the components it documents. Read the [getting started guide](/docs/getting-started) to compose your first scene.
