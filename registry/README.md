...
A **stub** of the source-registry distribution (shadcn-style: pull editable source into your project). [`registry.json`](./registry.json) is a machine-readable manifest mapping each component to its source files and dependencies.
